...
class ShopController extends Controller
{
    ...
    public function index()
    {
        ...
        $criteria = \App\Order::JOIN('users', 'users.id', '=', 'orders.user_id')
    ...
    public function myOrder()
    {
        ...
        $user = Auth::user();
        $criteria = \App\Order::where('user_id', '=', $user->id)->orderBy('id', 'desc')
            ->paginate(10);
        return new OrderResourceCollection($criteria);
    }

    public function searchHistoryMyOrder($keyword)
    {
        $user = Auth::user();
        $criteria = \App\Order::where('invoice_number', 'LIKE', "%" . $keyword . "%")
